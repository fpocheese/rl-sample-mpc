...
class A2RLObstacleCarver:
    ...
    def __init__(self, track_handler, cfg, global_planner=None):
        ...
        # Longitudinal: ignore opponent already behind ego by more than
        # both half-lengths (bumper-to-bumper = 0) + small margin
        self.behind_ignore_s    = self.opp_half_l + self.ego_half_l + 1.0  # ≈5.9m
