...
# -*- coding: utf-8 -*-
"""
Paper scenario: Turn 6-7 overtaking — LOCAL SEGMENT simulation.

Only simulates the specific track section (s_start → s_end).
Generates:
  1) IEEE trajectory figure (overview + 3 zoomed insets with vehicle rects,
     corridor, decision annotations)
  2) IEEE time-series (1×4 game-theoretic: gap, lateral, ego phase, opp tactic)
  3) GIF animation
...
def main():
    parser = argparse.ArgumentParser(
        description='Turn 6-7 local segment overtaking demo')
    ...
    PC.plot_trajectory(rec, events, th,
                       ...
                       s_plot_min=2300, s_plot_max=2720,
                       zoom_pad=18)
